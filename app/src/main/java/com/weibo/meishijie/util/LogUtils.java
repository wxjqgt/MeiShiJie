...
public final class LogUtils {
    ...
    private static void printDeviceInfo(final String filePath) {
        ...
        int versionCode = 0;
        try {
            PackageInfo pi = MeishijieApplication.getContext().getPackageManager().getPackageInfo(
                    MeishijieApplication.getContext().getPackageName(), 0);
            if (pi != null) {
    ...
    public static class Config {
        private Config() {
            ...
            if (Environment.MEDIA_MOUNTED.equals(Environment.getExternalStorageState())
                    && MeishijieApplication.getContext().getExternalCacheDir() != null){
                sDefaultDir = MeishijieApplication.getContext().getExternalCacheDir() + FILE_SEP + "log" + FILE_SEP;
            } else {
                sDefaultDir = MeishijieApplication.getContext().getCacheDir() + FILE_SEP + "log" + FILE_SEP;
            }
        }
